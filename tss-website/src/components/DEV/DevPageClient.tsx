  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="rounded-2xl border-[var(--border-color)]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <Link href="/dev/tasks">
          <Card className="rounded-2xl border-[var(--border-color)] hover:border-[var(--color-dev)]/50 transition-colors cursor-pointer">
            <CardHeader>
