    ...
    <section ref={containerRef} className="relative min-h-[80vh] flex flex-col items-center justify-center overflow-hidden rounded-[3rem] px-6 py-20 bg-black text-white">
      ...
      <motion.div style={{ y, opacity }} className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        <motion.div
          ...
          className="relative w-full max-w-4xl mx-auto mb-12 flex flex-col items-center"
        >
          <div className="relative">
            {/* Go to site button bubble */}
            <motion.div
            ...
            >
              <Link href="/games">
                <div className="bg-black border border-white/20 px-4 py-1.5 rounded-full shadow-2xl hover:bg-white hover:text-black transition-all cursor-pointer group/site">
                  <span className="text-[10px] font-black uppercase tracking-widest text-white group-hover/site:text-black">Go to Site</span>
                </div>
              </Link>
            </motion.div>
            ...
            <h1 className="text-7xl md:text-9xl font-black italic tracking-tighter flex flex-col leading-[0.8]">
              ...
              <span className="bg-gradient-to-r from-[#ff3366] via-[#ff00cc] to-[#9933ff] bg-clip-text text-transparent drop-shadow-[0_0_40px_rgba(255,51,102,0.4)]">STUDIO</span>
            </h1>
          </div>
        </motion.div>
        ...
        <motion.p
          ...
          className="text-lg md:text-2xl text-zinc-400 max-w-3xl mx-auto mb-14 leading-tight font-medium"
        >
          {content.hero.desc}
        </motion.p>
