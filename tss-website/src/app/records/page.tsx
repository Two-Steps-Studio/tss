  ...
  return (
    <div className="container mx-auto p-6 mt-20 max-w-7xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {records?.map((record) => (
          <Card key={record.id} className="group relative flex flex-col overflow-hidden rounded-[2.5rem] bg-black/40 border border-white/10 hover:border-[var(--color-records)] transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.5)]">
