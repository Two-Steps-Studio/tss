  ...
  if (error || !podcast) {
    return (
      <div className="container mx-auto p-6 mt-20 max-w-7xl">
        ...
        <Link href="/records/podcasty" className="inline-flex items-center gap-2 px-6 py-3 bg-[var(--color-records)] hover:bg-[var(--color-records)]/90 text-white rounded-full font-medium transition-colors shadow-lg">
          <ArrowLeft size={18} />
          Wróć do podcastów
        </Link>
      </div>
